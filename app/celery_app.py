...
REDIS_HOST = os.environ.get("EA_SCHEDULER_HOST", "secflow-app-entry-analyse-scheduler")
...
app = Celery("ea", broker_url=broker_url, result_backend=result_backend,
...
def _ensure_db() -> None:
    ...
    try:
        ...
        logger.info("DB initialized for celery/dispatcher process: %s:%s",
